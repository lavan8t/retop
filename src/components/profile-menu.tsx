...
export const ProfileMenu: React.FC<ProfileMenuProps> = ({
  ...
  const menuVariants: Variants = {
    ...
    visible: {
      ...
      scale: 1,
      y: 0,
      transition: { ...iosSpring, staggerChildren: 0.02 } as Transition,
    },
    exit: {
      opacity: 0,
      scale: 0.5,
  ...
  const itemVariants: Variants = {
    ...
    visible: { opacity: 1, scale: 1, y: 0, transition: iosSpring },
  };
  ...
  return (
    <motion.div
      ...
      animate="visible"
      exit="exit"
      className="absolute right-4 top-2 w-64 bg-(--bg-surface) border-4 border-(--border-main) rounded-4xl shadow-[8px_8px_0px_0px_var(--border-main)] z-50 overflow-hidden origin-top-right flex flex-col will-change-transform transform-gpu"
    >
